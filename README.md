...
- **Web app:** M1 — dashboard, crea goal, checkout, incasso, withdraw su Fuji, tutti provati a mano ([`docs/e2e-m1.md`](docs/e2e-m1.md)). M2 — pagina Nomi (claim del namespace, nome per ogni goal) e incasso scrivendo un nome: i nomi on-chain sono stati creati e risolvono, la prova a mano della pagina è ancora aperta ([`docs/e2e-m2.md`](docs/e2e-m2.md)).
