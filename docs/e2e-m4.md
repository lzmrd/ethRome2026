...
| 3 | Apro un browser diverso, stessa identità Swarm, ricarico | la nota ricompare | ✅ osservato: secondo browser, stessa origine `http://localhost:5173`, accesso all'identità `0xfede` con frase di recupero e password; «bar testaccio · bar · ottimo caffè» ricompare sulla riga «Prelievo 1.8 USDC». Nessun dato locale condiviso fra i due browser: la nota è tornata dal feed | — |
