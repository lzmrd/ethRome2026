...
- **Commands (contracts):** `cd contracts && ~/.foundry/bin/forge test` · deploy/scripts: `~/.foundry/bin/forge script <script> --rpc-url fuji --broadcast --priority-gas-price 1 --with-gas-price 1000` · frontend: `cd frontend && pnpm install && pnpm dev` · build: `pnpm build`
